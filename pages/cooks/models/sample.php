<?php
  ...
  $user = get_info_user($link, $id);

  $title = 'Список поваров | ' . $user[0]['name_1'] . ' ' . $user[0]['name_2'];
...
<?php
  ...
  $data = [
    ...
    ['link_page' => 'https://yum-food.ru/pages/cook/', 'name_page' => $user[0]['name_1'] . ' ' . $user[0]['name_2']],
  ];
          ...
          <div class="bg-white border-block box-shadow p-5">
            <div class="row justify-content-center">
              <div class="col-12 d-md-flex align-items-md-center text-center text-md-left">
                <img src="<?= $user[0]['photo_link'] ?>" class="img-people mb-4 mb-md-0 mr-0 mr-md-5" alt="">
                <div>
                  <p class="text-12 text-medium mb-2"><?= $user[0]['name_1'] ?> <?= $user[0]['name_2'] ?> | ???</p>
                  <p class="mb-1"><?= $user[0]['about'] ?></p>
                  <p class="mb-1">Мясо - моя страсть!</p>
                  <p><?= get_address($user[0]['city'], $user[0]['street'], $user[0]['house']) ?></p>
                </div>
              </div>
            </div>
          </div>
